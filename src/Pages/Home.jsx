      ...
      <div className="container w-full h-full flex flex-col gap-32 max-w-7xl px-[140px] py-[83px]">
        ...
        <main className="main w-full flex flex-row justify-between items-center gap-x-32">
          <div className="main_left flex flex-col justify-center items-start gap-5">
            <h1 className='text-[#313E51] text-6xl font-light'>Welcome to the</h1>
            <h1 className='text-[#313E51] text-6xl font-medium'>Frontend Quiz!</h1>
            <p className='text-[#626C7F] text-xl font-normal'>Pick a subject to get started.</p>
          </div>
          <div className="main_right">Hello World!</div>
        </main>
      </div>
    </div>
  )
